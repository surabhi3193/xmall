...
public class PostOwnerProfileActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void initui() {
        ...
        dob_lay = findViewById(R.id.dobLay);
        mobile_lay = findViewById(R.id.contactLay);
        email_lay = findViewById(R.id.emailLay);


        back_btn = findViewById(R.id.back_btn);
        profile_image = findViewById(R.id.profile_image);
        GenderText = findViewById(R.id.GenderText);
        owner_nameTV = findViewById(R.id.owner_name);
        ...
        socialTV = findViewById(R.id.socialTV);
        mRecyclerView = findViewById(R.id.recycler_view);
        mRecyclerView_vdo = findViewById(R.id.recycler_view_vdo);

        mRecyclerView.setHasFixedSize(true);
        mRecyclerView_vdo.setHasFixedSize(true);


        Typeface face = ResourcesCompat.getFont(PostOwnerProfileActivity.this, R.font.estre);
        ...
        divider.setDrawable(Objects.requireNonNull(ContextCompat.getDrawable(getApplicationContext(), R.drawable.my_custom_divider)));
