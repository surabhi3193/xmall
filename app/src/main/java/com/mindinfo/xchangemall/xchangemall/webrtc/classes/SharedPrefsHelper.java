...
public class SharedPrefsHelper {
    private static final String SHARED_PREFS_NAME = "xmall";
    ...
    private SharedPrefsHelper() {
        instance = this;
        sharedPreferences = XchangemallApplication.getInstance().getSharedPreferences(SHARED_PREFS_NAME, Context.MODE_PRIVATE);
    }
    ...
    public boolean hasQbUser() {
        System.out.println("- check user ------- " + QB_USER_LOGIN);
