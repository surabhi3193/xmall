package com.mindinfo.xchangemall.xchangemall.webrtc.classes.adapters;
...
import com.mindinfo.xchangemall.xchangemall.webrtc.classes.utils.QBRTCSessionUtils;
...
//        holder.getOpponentView().setId(user.getId());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public SurfaceView getOpponentView() {
            return opponentView;
        }
