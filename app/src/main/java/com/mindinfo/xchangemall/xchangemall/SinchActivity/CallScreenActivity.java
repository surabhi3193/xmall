...
import com.mindinfo.xchangemall.xchangemall.other.AudioPlayer;
...
public class CallScreenActivity extends BaseActivity {
    ...
    private void updateUI() {
        ...
        Call call = getSinchServiceInterface().getCall(mCallId);
        if (call != null) {
            getUserProfile(call.getRemoteUserId());
...
//                        Toast.makeText(context, responseobj.getString("message"), Toast.LENGTH_LONG).show();
                      ...
                      String  username = responseobj.getJSONObject("result").getString("first_name");
